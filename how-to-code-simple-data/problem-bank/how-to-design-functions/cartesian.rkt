...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname cartesian) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; Number Number Number Number -> Number
;; Gives us the distance between two coordinates given in the input as x1, y1, x2, y2
...
(check-within (distance 1 0 0 1) (sqrt 2) 1e-06)
